...
const VendorList = ()=>{
    ...
    const headings = ["Vendor Id","Other Trading Name","Individual/SoleTrader","Registration Number",
                      "Country of Operation","Vendor Status","Active Users","Inactive Users",""];
    const data = [{vendorId:"Vendor Id",otherTradingName:"Other Trading Name",soleTrader:"SoleTrader",registrationNumber:"Registration Number",
    countryOfOperation:"Country of Operation",vendorStatus:"Vendor Status",activeUsers:5,inactiveUsers:2
                  }]
    
const buttons = [{name:'profile',path:'/vendor/'},{name:'edit',path:'/vendor/edit/'},{name:'delete',path:'/vendor/delete/'}]
    // useEffect(()=>{
    ...
    return(
      <ListTable srno={false}buttons={buttons} headings={headings} data={data}  />
